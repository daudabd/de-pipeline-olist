...
spark = (SparkSession.builder
        .appName("OrderItems")
        .config("spark.jars", "/home/daudabd/jdbc_drivers/postgresql-42.7.11.jar")
        .getOrCreate()
)

# Read from the container's mounted data folder
df = spark.read.option("header", True).option("inferSchema", True).csv("/home/daudabd/de-pipeline-olist/data/raw/olist_order_items_dataset.csv")
...
jdbc_url = "jdbc:postgresql://localhost:5433/olist_db"
